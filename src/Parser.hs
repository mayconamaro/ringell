...
happyExpList = Happy_Data_Array.listArray (0,80) ([0,24,1024,32768,1,4,0,16384,0,66,4224,0,0,1152,16896,0,0,2560,2048,1,8,2304,32768,16384,1039,0,62464,64,512,32,53248,259,16628,0,16,0,976,1,32768,0,3904,2052,4,1024,128,40960,0,8192,32768,16,0,0,53248,291,16628,1152,8192,0,0,1,8,4157,32,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Prog","Exp","Type","Fun","'.'","match","zero","suc","'\\\\'","int","'('","')'","'='","':'","\"->\"","nat","main","var","%eof"]
...
action_14 (16) = happyShift action_19
...
action_21 (8) = happyShift action_29
...
action_22 (5) = happyGoto action_33
...
action_26 (12) = happyShift action_24
...
action_30 (8) = happyShift action_29
action_30 (15) = happyShift action_36
...
action_33 (8) = happyShift action_29
...
happyReduction_2 ((HappyAbsSyn5  happy_var_6) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (MainF happy_var_3 happy_var_6
	) `HappyStk` happyRest

happyReduce_3 = happySpecReduce_1  5 happyReduction_3
happyReduction_3 (HappyTerminal (ID happy_var_1))
	 =  HappyAbsSyn5
		 (Var happy_var_1
	)
...
happyReduction_4 (HappyTerminal (Num happy_var_1))
	 =  HappyAbsSyn5
		 (NumE happy_var_1
	)
...
happyReduction_8 ((HappyAbsSyn5  happy_var_9) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (MatchE happy_var_2 happy_var_5 (happy_var_7, happy_var_9)
	) `HappyStk` happyRest
...
happyReduction_13 ((HappyAbsSyn5  happy_var_6) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn7
		 (Fun happy_var_1 happy_var_3 happy_var_4 happy_var_6
	) `HappyStk` happyRest
...
happyNewToken action sts stk (tk:tks) =
	...
	Nat -> cont 19;
	Main -> cont 20;
	ID happy_dollar_dollar -> cont 21;
	_ -> happyError' ((tk:tks), [])
	}
